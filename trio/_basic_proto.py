'''
synchronous routines to load/parse a read buffer and utilities to convert
...
def deframe(proto, maxbuf=MAX_BUF, **kw_proto):
    ...
    returns a function which converts raw data into on iterator of messages that exausts buffer
    '''
    buf = bytearray()
    pos = 0
    ...
    def append(chunk):
        '''
        add chunk to buffer, return iterator of protocol's results
